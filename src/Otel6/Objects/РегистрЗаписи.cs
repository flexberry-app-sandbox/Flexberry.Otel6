...
namespace IIS.Otel6
{
    ...
    public class РегистрЗаписи : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрЗаписиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрЗаписиE", typeof(IIS.Otel6.РегистрЗаписи));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрЗаписи : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Otel6.DetailArrayOfРегистрЗаписи members)

        // *** End programmer edit section *** (IIS.Otel6.DetailArrayOfРегистрЗаписи members)
        ...
        /// </summary>
        public DetailArrayOfРегистрЗаписи(IIS.Otel6.Доступ fДоступ) : 
                base(typeof(РегистрЗаписи), ((ICSSoft.STORMNET.DataObject)(fДоступ)))
        {
        }
        
        public IIS.Otel6.РегистрЗаписи this[int index]
        {
            get
            {
                return ((IIS.Otel6.РегистрЗаписи)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Otel6.РегистрЗаписи dataobject)
        {
